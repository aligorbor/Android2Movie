...
import ru.geekbrains.android2.movieapp.App.Companion.appInstance
import ru.geekbrains.android2.movieapp.R
import ru.geekbrains.android2.movieapp.view.MainFragment
...
class FCMService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {
        ...
        appInstance?.let {
            val preferences =
                it.getSharedPreferences(MainFragment.preferencesName, Context.MODE_PRIVATE)
